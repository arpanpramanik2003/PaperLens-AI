        ...
        <div className="p-3 sm:p-4 flex-1 overflow-hidden flex flex-col gap-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-3 min-h-0 flex-1">
              ...
              <div className="space-y-2 overflow-y-auto pr-1 max-h-[170px] sm:max-h-[210px]">
                {topRefs.map((ref, idx) => (
                  ...
                  >
                    ...
                    <div className="mt-1.5 inline-flex items-center gap-1 text-[10px] font-medium text-accent">
            ...
            <div className="lg:col-span-2 min-h-0">
              <div className="rounded-lg border border-border bg-card p-2.5 h-full shadow-xs flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-1.5 mb-2">
                  ...
                  <div className="mb-2 rounded-md bg-muted/40 border border-border/60 p-2">
                    <p className="text-[10px] uppercase tracking-wide text-muted-foreground font-semibold mb-1">Paper Focus</p>
                ...
                <div className="mt-2.5 inline-flex items-center gap-1 text-[10px] text-muted-foreground">
