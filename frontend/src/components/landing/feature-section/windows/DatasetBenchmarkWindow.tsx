        ...
        <div className="flex-1 overflow-y-auto p-3 sm:p-4 flex flex-col">
          {!showResults ? (
            <div className="space-y-3 mb-4">
              <div>
                <label className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider mb-1 block">Project Title</label>
                <input
                  type="text"
                  placeholder="Brain tumor classification"
                  value={projectTitle}
                  onChange={(e) => setProjectTitle(e.target.value)}
                  className="w-full bg-card border border-border rounded-lg px-3 py-1.5 text-xs text-foreground focus:outline-none focus:border-accent"
                />
              </div>

              <div>
                <label className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider mb-1 block">Project Plan (Optional)</label>
                <textarea
                  ...
                  className="w-full bg-card border border-border rounded-lg px-3 py-2 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-accent h-20 resize-none"
                />
              ...
              <motion.button
                ...
                className="w-full bg-accent text-accent-foreground hover:bg-accent/90 px-4 py-2 rounded-lg text-xs font-semibold flex items-center justify-center gap-2 transition-colors shadow-sm"
            ...
            <>
              <div className="mb-4 pb-4 border-b border-border">
                <p className="text-[11px] uppercase tracking-wider text-accent font-semibold mb-1">Domain Understanding</p>
              ...
              <div className="mb-4 pb-4 border-b border-border">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                  {datasets.map((dataset, idx) => (
                    <div
                      key={idx}
                      className="bg-card border border-border rounded-lg p-2.5 hover:border-accent/40 transition-colors shadow-xs"
                    >
