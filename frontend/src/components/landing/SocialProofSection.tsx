  ...
  return (
    <section className="relative py-8 sm:py-12 bg-transparent">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <p className="text-center text-xs font-medium text-muted-foreground uppercase tracking-[0.2em] mb-6">
        ...
        <div className="flex items-center justify-center flex-wrap gap-5 sm:gap-10">
          {institutions.map((inst, i) => (
            <motion.span
              key={inst.name}
              className="font-mono text-sm sm:text-base font-semibold text-muted-foreground cursor-default select-none transition-all duration-300 hover:text-accent"
